...
namespace CRDNID
{
    ...
    class RDNID
    {
        ...
        //        private static extern IntPtr selectReaderRD([MarshalAs(UnmanagedType.LPTStr)] string _szReaders);
        ...
        //public Int32 closeRDNID(string close)
        //{
        //    byte[] cl = String2Byte(close);
        //    //closeRDNID();
        //    return closeRDNID(close);
        //}
